...
export const metadata: Metadata = {
  ...
  title: {
    default: `Privacy Policy - ${APP_NAME}`,
    template: `%s | ${APP_NAME}`,
  },
  description:
    "Learn how addcn collects, uses, and protects your personal information when using our component registry platform.",
  keywords: [
    "privacy policy",
    "data protection",
    "addcn",
...
export default async function PrivacyPage() {
  const filePath = join(process.cwd(), "content", "privacy-policy.md");
